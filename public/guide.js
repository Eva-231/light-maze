...
const TUTORIALS=[
  ...
  ['罠','小さな床紋章に注意。刺突・鈍足・召喚・吸光・魔封じ・暗幕・転移・毒針。光弾で狙って破壊できます。'],
  ['採掘・遺物','光る鉱脈を狙って採掘を長押し。遺物は生還して初めて持ち帰れる。'],
  ['黄金の番人','金の二重円・光柱 → 円の外へ。着弾後に爆発。爆発後、光る核へ反撃。']
];
...
const ENEMIES=[
  ...
  ['黄金の番人','#ffc66e','金色ビーム→足元の二重円が爆発／近距離の大円','二重円の外へ／大円から離れる','爆発・叩きつけ後に光る核']
];
